      ...
      <div class="col-6">
        <form action="/controllers/newProduct.php" method="POST">
          ...
          <input onkeyup="slug_generator()" type="text" name="product" id="product"
            value="<?php echo (isset($_SESSION['newProduct']['title'])) ? $_SESSION['newProduct']['title'] : '' ?>" /><br /><br />
          <label for="slug">Slug</label><br />
          <input type="text" id="slug" name="slug"
            value="<?php echo (isset($_SESSION['newProduct']['slug'])) ? $_SESSION['newProduct']['slug'] : '' ?>"></input><br /><br />
          <label for="description">Beschreibung</label><br />
          <textarea id="description"
            name="description"><?php echo (isset($_SESSION['newProduct']['description'])) ? $_SESSION['newProduct']['description'] : '' ?></textarea><br /><br />
          <label for="price">Preis (in cent)</label><br />
          <input type="number" id="price" name="price"
            value="<?php echo (isset($_SESSION['newProduct']['price'])) ? $_SESSION['newProduct']['price'] : '' ?>"></input><br /><br />
          ...
          <input type="number" id="quantity" name="quantity"
            value="<?php echo (isset($_SESSION['newProduct']['quantity'])) ? $_SESSION['newProduct']['quantity'] : '' ?>"></input><br /><br />
