      ...
      <div class="col-6">
        ...
        <form action="/controllers/register.php" method="POST">
          ...
          <input id="first_name" type="text" name="first_name"
            value="<?php echo (isset($_SESSION['registerFirstname'])) ? $_SESSION['registerFirstname'] : ''?>"><br /><br />
          <label for="last_name">Nachname</label><br />
          <input id="last_name" type="text" name="last_name"
            value="<?php echo (isset($_SESSION['registerLastname'])) ? $_SESSION['registerLastname'] : ''?>"><br /><br />
          <label for="email">Email</label><br />
          <input id="email" type="email" name="email"
            value="<?php echo (isset($_SESSION['registerEmail'])) ? $_SESSION['registerEmail'] : ''?>"><br /><br />
          <label for="passwd">Passwort</label><br />
          <input id="passwd" type="password" name="passwd"
            value="<?php echo (isset($_SESSION['registerPassword'])) ? $_SESSION['registerPassword'] : ''?>"><br /><br />
